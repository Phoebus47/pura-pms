...
- **Supabase (DB, Auth, RLS, MCP, logs)** → `supabase`
- **Postgres schema / RLS / indexes / SQL** → `supabase-postgres-best-practices`
...
| `supabase`                         | Supabase products, MCP, Auth, RLS, logs                |
| `supabase-postgres-best-practices` | Postgres schema, RLS, indexes, SQL on Supabase         |

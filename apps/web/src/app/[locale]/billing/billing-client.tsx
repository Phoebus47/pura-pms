...
export function BillingClient() {
  ...
  function renderMain() {
    if (reservationId === '') {
      return (
        <div className="bg-surface-desk border border-rule-mist p-10 rounded-xl text-center">
          <Receipt className="h-14 mb-4 mx-auto text-muted-foreground/40 w-14" />
          <h2 className="font-semibold text-foreground text-xl">
            {t('billing.selectReservation')}
          </h2>
          <p className="max-w-md mt-2 mx-auto text-muted-foreground text-sm">
    ...
    if (loadingRes) {
      return (
        <div className="bg-surface-desk border border-rule-mist flex flex-col h-48 items-center justify-center rounded-xl">
    ...
    return (
      <>
        <div className="bg-surface-desk border border-rule-mist flex flex-wrap gap-6 items-start justify-between p-6 rounded-xl shadow-sm">
          <div>
